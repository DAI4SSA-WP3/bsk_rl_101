...
plt.savefig(save_results_to + 'Case_2_Reward'+ datetime.today().strftime('%Y%m%d_%H%M%S') +'.png', dpi = 300)
...
plt.savefig(save_results_to + 'Case_2_Battery'+ datetime.today().strftime('%Y%m%d_%H%M%S') +'.png', dpi = 300)
...
plt.savefig(save_results_to + 'Case_2_DataStorage'+ datetime.today().strftime('%Y%m%d_%H%M%S') +'.png', dpi = 300)