...
def train_agent(seed_num):
    ...
    true_anomaly_offsets = [
        225-i*0.0001 for i in range(len(satellite_names))]  # degrees
    ...
    env = GeneralSatelliteTasking(
        satellites=multiSat,
        scenario=scene.UniformTargets(target_total),
        ...
        # vizard_dir="./tmp/vizard",                 # activate this line to record visualization
        # vizard_settings=dict(showLocationLabels=-1),      # activate this line to record visualization
    )
