...
sat_args = dict(
    ...
    storedCharge_Init=lambda: 400*3600,#np.random.uniform(300 * 3600 * 0.2, 400 * 3600 * 0.8), ==> Fully charged
    ...
    # Data Storage
    dataStorageCapacity=1000 * 8e9,  # MB to bits, ==> 1 TB
...
plt.savefig(save_results_to + 'Case_1_DataStorage'+ datetime.today().strftime('%Y%m%d_%H%M%S') +'.png', dpi = 300)