...
plt.savefig(save_results_to + 'Case_3_Reward'+ datetime.today().strftime('%Y%m%d_%H%M%S') +'.png', dpi = 300)
...
plt.savefig(save_results_to + 'Case_3_Battery'+ datetime.today().strftime('%Y%m%d_%H%M%S') +'.png', dpi = 300)
...
plt.savefig(save_results_to + 'Case_3_DataStorage'+ datetime.today().strftime('%Y%m%d_%H%M%S') +'.png', dpi = 300)